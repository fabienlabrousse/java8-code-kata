...
public class Exercise3Test {
    ...
    public void localDateTimeOf() {
         ...
         */
        LocalDateTime localDateTime = LocalDateTime.of(2015,06,20,23,7,30);
    ...
    public void localTimeWith() {
         ...
         */
        LocalDateTime localDateTime = LocalDateTime.from(ldt).with(TemporalAdjusters.firstDayOfNextMonth())
    ...
    public void localDatePlusMinus() {
         ...
         */
        LocalDateTime localDateTime = LocalDateTime.from(ldt).plusMonths(10).minusHours(5);
