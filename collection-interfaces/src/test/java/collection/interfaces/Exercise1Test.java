...
public class Exercise1Test extends ClassicOnlineStore {
    ...
    public void iterateByForEach() {
         ...
         */
        Consumer<Customer> addToNameList = customer -> nameList.add(customer.getName());
        customerIterable.forEach(addToNameList);
    ...
    public void whoHaveNoEInYourName() {
         ...
         */
        Predicate<String> nameContainsE = s -> s.contains("e");
        nameCollection.removeIf(nameContainsE);
    ...
    public void replaceTheElements() {
         ...
         */
        UnaryOperator<String> parenthesisWrapper = s -> "("+s+")";
        nameList.replaceAll(parenthesisWrapper);
    ...
    public void sortByName() {
         ...
         */
        Comparator<String> nameLengthAsc = Comparator.comparingInt(String::length);
        nameList.sort(nameLengthAsc);
