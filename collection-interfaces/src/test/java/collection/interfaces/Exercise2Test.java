...
public class Exercise2Test {
    ...
    public void mergeValues() {
         ...
         */
        BiFunction<Integer, Integer, Integer> sumIfPresent = (integer, integer2) -> integer+integer2;
        map.merge("Alice",32,sumIfPresent);
        map.merge("Joe",32,sumIfPresent);
    ...
    public void ignoringAbsentKeys() {
         ...
         */
        BiFunction<String, Integer, Integer> addOneIfPresent = (key, value) -> value+1;
        map.computeIfPresent("Joe",addOneIfPresent);
        map.computeIfPresent("Steven",addOneIfPresent);
        map.computeIfPresent("Alice",addOneIfPresent);
